...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://b.insurancekb.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '保险, 董责险, 并购险, 基金综合保险, 团财险, 企业保险, 雇主责任险, ', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Insurance Knowledge Base', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '只站在客户立场，配置最适合的保险', // 站点描述，被notion中的页面描述覆盖
